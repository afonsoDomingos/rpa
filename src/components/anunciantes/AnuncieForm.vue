        ...
        <section class="section">
          ...
          <div class="group">
            ...
            <p v-else-if="form.ctaLink" class="success-text">
              Link gerado:
              <a :href="form.ctaLink" target="_blank">{{ form.ctaLink }}</a>
            </p>
          </div>
        </section>
        ...
        <section class="section">
          ...
          <div class="group">
            ...
            >
              ...
              <span v-if="!form.image" class="upload-text"
                >Adicionar foto (Máx 2Mb)</span
              >
...
const handleSubmit = async () => {
  ...
  try {
    ...
    submitError.value =
      err.response?.data?.mensagem || "Erro ao criar anúncio.";
  } finally {
    loading.value = false;
  }
};
...
.upload-label.has-image .upload-text {
  color: #10b981;
  font-weight: 600;
}
