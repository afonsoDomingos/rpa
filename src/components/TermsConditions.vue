    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6 my-auto">
          ...
          <p class="pe-5">
            Na RecuperaAqui, reconhecemos que perder um documento pode significar mais do que um transtorno — pode representar um pedaço de identidade, um momento de dor ou confusão. Por isso, nossa missão é estender a mão com empatia, responsabilidade e clareza.
          </p>
        ...
        <div class="col-lg-6 mt-lg-0 mt-5 ps-lg-0 ps-0">
          <TermsOption
            icon="token"
            content=" <strong>1.Uso da Plataforma</strong><br /> Ao usar a RPA, você aceita estes termos e se compromete<br />
             a agir com honestidade e responsabilidade."
          />
          <TermsOption
            icon="token"
            content="<strong>2.Objetivo</strong><br /> A plataforma conecta quem perdeu documentos com quem <br />
           os encontrou, promovendo a solidariedade."
          />
          ...
          />
           <TermsOption
            icon="token"
            content="<strong>4.Privacidade</strong><br /> Seus dados são protegidos. Números de documentos e contatos<br />
            só são mostrados quando necessário."
          />
          <TermsOption
            icon="token"
            content="<strong>5.Suspensão de Conta</strong><br /> Quem usar a plataforma de forma indevida poderá ter a conta<br />
             suspensa ou excluída."
          />
          <TermsOption
            icon="token"
            content="<strong>6.Alterações</strong><br /> Os termos podem ser atualizados, por isso é bom revisá-los <br />
             periodicamente."
          />
          <TermsOption
            icon="token"
