<template>
  <div>
    ...
    <div
      class="container-fluid pag-container-fluid py-4 my-4 bg-white shadow-sm rounded borda-destacada pag-container-responsive"
    >
        ...
        <div class="container">
          ...
          <div class="text-center mb-5">
            ...
            <p class="lead text-muted">
              Sistema especializado para recuperação de veículos roubados ou
              furtados
            </p>
            <div class="alert alert-warning mt-4 fw-bold" role="alert">
              🚧 Esta página ainda está em desenvolvimento. Algumas
          ...
          <div class="row g-4 mb-5">
            <div
              class="col-md-4"
              v-for="(valor, chave) in statsDisplay"
              :key="chave"
            >
              <div
                class="card shadow-lg border-0 stat-card h-100 text-center p-3"
              >
            ...
            <div class="card-body">
              ...
              <div class="row g-3">
                ...
                <div class="col-md-4 d-grid">
                  <button @click="buscarViatura" class="btn btn-green fw-bold">
                    🔍 Buscar
                  </button>
                </div>
              </div>
          ...
          <div class="card glass-card mb-5 shadow-lg">
            <div class="card-body">
              <h2 class="h4 fw-bold mb-4 text-purple">
                Reportar Viatura Roubada/Furtada
              </h2>
              <form @submit.prevent="reportarViatura">
                <div class="row g-3">
                  <div
                    class="col-md-6"
                    v-for="(field, key) in reportFields"
                    :key="key"
                  >
                    <div
                    ...
                    >
                      ...
                      />
                      <div
                        v-if="reportForm.fotoPreview"
                        class="image-preview mt-3 mx-auto"
                      >
                        <img
                          :src="reportForm.fotoPreview"
                          alt="Foto da viatura"
                        />
                      </div>
                    </div>
          ...
          <div class="card glass-card shadow-lg">
            <div class="card-body">
              ...
              <div class="row g-4">
                <div
                  v-for="viatura in pagedViaturas"
                  :key="viatura.id"
                ...
                >
                  <div class="card h-100 border-0 shadow-sm case-card">
                    <div
                      ...
                      @click="viatura.foto && openZoom(viatura.foto)"
                    >
                      <img
                        v-if="viatura.foto"
                        :src="viatura.foto"
                    ...
                    <div class="card-body d-flex flex-column">
                      ...
                      <p class="mb-1">
                        <strong>Proprietário:</strong> {{ viatura.nome }}
                      </p>
                      <p class="mb-1">
                        <strong>Contacto:</strong> {{ viatura.contacto }}
                      </p>
                      <p class="mb-1">
                        <strong>Placa:</strong> {{ viatura.placa }}
                      </p>
                      ...
                      >
                        ...
                        <span
                          v-if="viatura.recompensa"
                          class="badge bg-green text-white fs-6"
                        >
                          💰 {{ viatura.recompensa.toLocaleString("pt-MZ") }} MT
                        </span>
                        <button
                          @click="contatarProprietario(viatura.id)"
...
const viaturasAtivas = ref([
  ...
  },
  {
    ...
    placa: "JKL-3456",
    recompensa: 3000,
    descricao: "Roubado na Av. Moçambique",
    dataRoubo: "18/01/2024",
    foto: null,
  },
  {
    id: 5,
    ...
    placa: "MNO-7890",
    recompensa: 4000,
    descricao: "Furtado próximo à estação de serviço",
    dataRoubo: "20/01/2024",
    foto: null,
  },
  {
    id: 6,
    ...
    placa: "PQR-2345",
    recompensa: 2500,
    descricao: "Roubado na rua central",
    dataRoubo: "22/01/2024",
    foto: null,
  },
  {
    id: 7,
    ...
    placa: "STU-6789",
    recompensa: 6000,
    descricao: "Furtado à noite no bairro sul",
    dataRoubo: "25/01/2024",
    foto: null,
  },
]);
...
const page = ref(1);
const pageSize = 3;
const pagedViaturas = computed(() => {
  const start = (page.value - 1) * pageSize;
  return viaturasAtivas.value.slice(start, start + pageSize);
});
const hasNextPage = computed(
  () => page.value * pageSize < viaturasAtivas.value.length
);
...
onMounted(() => {
  autoTimer = setInterval(() => {
    hasNextPage.value ? page.value++ : (page.value = 1);
  }, 5000);
});
onBeforeUnmount(() => {
