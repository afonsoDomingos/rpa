                ...
                >
                  ...
                  >
                    ...
                    <div class="d-flex p-2 text-white">
                      ...
                      <div class="ps-3">
                        <span class="text-sm opacity-8">(+258) 847877405</span>
                      </div>
                    </div>
                    <div class="d-flex p-2 text-white">
                      <div>
                    ...
                    <div class="mt-4">
                      <MaterialButton
                        ...
                        data-original-title="Faça login com o Facebook"
                      >
                      ...
                      <MaterialButton
                        ...
                        data-toggle="tooltip"
                        data-placement="bottom"
                        data-original-title="Faça login com o Twitter"
                      >
                      ...
                      <MaterialButton
                        ...
                        data-toggle="tooltip"
                        data-placement="bottom"
                        data-original-title="Faça login com Dribbble"
                      >
                      ...
                      <MaterialButton
                        ...
                        data-toggle="tooltip"
                        data-placement="bottom"
                        data-original-title="Faça login com Instagram"
                      >
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-12 pe-2 mb-3">
                        <MaterialInput
                          ...
                          type="text"
                          placeholder="Nome do que perdeu"
                        />
                      </div>
                      <div class="col-md-12 pe-2 mb-3">
                        <MaterialTextArea
                          class="input-group-static mb-4"
                          placeholder="Gostava de saber..."
                          :rows="6"
                          >Sua mensagem</MaterialTextArea
                        >
                      </div>
                    </div>
                    <div class="row">
                      <div class="col-md-6 text-end ms-auto">
                        <MaterialButton
                          ...
                          type="submit"
                          class="mb-0"
                          >Enviar mensagem</MaterialButton
                        >
                      </div>
                    </div>
                  </div>
