      ...
      <div class="row">
        <div class="col-lg-4 me-auto mb-lg-0 mb-4 text-lg-start text-center">
          ...
          <p class="text-sm text-dark opacity-8 mb-0">
            Copyright © {{ new Date().getFullYear() }} RPA. Todos os direitos reservados.
          </p>
        </div>
        <div class="col-lg-6 ms-auto text-lg-end text-center">
          <p class="mb-5 text-lg text-dark font-weight-bold">
            A recompensa por recuperar um documento é a gratidão. O preço da gratidão é estar sempre pronto para ajudar.
          </p>
          <a
            href="javascript:;"
            target="_blank"
