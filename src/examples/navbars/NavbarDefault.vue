...
<template>
  <nav class="navbar navbar-expand-lg top-0 position-fixed mx-auto my-3"
    ...
    <div class="container px-0">
      ...
      <!-- Logo Desktop com efeito hover -->
      <RouterLink
        class="navbar-brand d-none d-md-block animated-logo"
      ...
      <!-- Logo Mobile -->
      <RouterLink
        class="navbar-brand d-block d-md-none animated-logo"
        :to="{ name: 'presentation' }"
        rel="tooltip"
        title="Página inicial"
      >
              ...
              <div class="row">
                <div class="col-12 px-4 py-2">
                  <div class="position-relative">
                    ...
                    <RouterLink :to="{ name: 'contactus' }" class="dropdown-item border-radius-md" @click="fecharDropdown">
                      Contacte-nos
                    </RouterLink>
                    ...
                    <RouterLink :to="{ name: 'signin-basic' }" class="dropdown-item border-radius-md" @click="fecharDropdown">
                      Inscrever-se
                    </RouterLink>
                  </div>
                </div>
